...
public class ManagePurchaseFrame extends JFrame implements ActionListener
{
	...
	User user;
	PurchaseRepo pr=new PurchaseRepo();
	public ManagePurchaseFrame(User user)
	{
		...
		ConfirmBtn.setBounds(150,300,100,40);
		ConfirmBtn.addActionListener(this);
		panel.add(ConfirmBtn);
		
		SearchBtn = new JButton ("SEARCH");
		SearchBtn.setBounds(250,300,100,40);
		SearchBtn.addActionListener(this);
		panel.add(SearchBtn);
		
		UpdateBtn = new JButton("UPDATE");
		UpdateBtn.setBounds(350,300,100,40);
		UpdateBtn.addActionListener(this);
		panel.add(UpdateBtn);
		
		
		BackBtn = new JButton("BACK");
		BackBtn.setBounds(450,300,100,40);
		BackBtn.addActionListener(this);
		panel.add(BackBtn);
		
		
	    LogoutBtn = new JButton("LOGOUT");
	    LogoutBtn.setBounds(550,300,100,40);
		LogoutBtn.addActionListener(this);
		panel.add(LogoutBtn);
		
		
		DeleteBtn = new JButton("DELETE");
	    DeleteBtn.setBounds(650,300,100,40);
